...
Before changing Studio's visual editing surface, read the user-facing
[Canvas](/studio/canvas), [Layers](/studio/layers),
[Timeline](/studio/timeline), and [Design](/studio/design) guides. Preserve
Studio's capability gates and source-patching behavior, and use the existing
tests and implementation as the technical source of truth.

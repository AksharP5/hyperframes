...
Open the symptom that looks most like yours. You should not need to understand the rendering architecture to solve a normal problem.

<AccordionGroup>
  <Accordion title="Studio will not open" icon="window">
  ...
  <Accordion title="Preview is wrong or stale" icon="rotate">
    A saved change is missing, playback looks old, or the preview is blank. Try these in order:
  ...
  <Accordion title="I cannot select or edit something" icon="arrow-pointer">
  ...
  <Accordion title="Media is missing or black" icon="photo-film">
  ...
  <Accordion title="Animation is wrong" icon="wand-magic-sparkles">
  ...
  <Accordion title="Render failed or differs from preview" icon="film">

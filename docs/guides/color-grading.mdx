...
Start with a preset. There are eighteen, from Clean Studio and Skin Soft to VHS
Playback, and Studio renders each as a thumbnail of **your** frame rather than
someone else's sample. **Strength** dials the chosen look between nothing and
full.

{/* VISUAL NEEDED (1): Studio's preset thumbnail grid — all eighteen presets on
one real frame, Clean Studio through VHS Playback. */}

...
You may still see project files and terminal commands because those are how the agent and HyperFrames work underneath. Start with [Create with an agent](/guides/create-with-agent).
...
Use [Choose your path](/guides/choose-your-path) to find the shortest workflow for your input.

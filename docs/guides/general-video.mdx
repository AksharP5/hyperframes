...
<Frame caption="Four real Catalog scenes in sequence. This workflow is the one that composes anything the focused paths do not cover.">
  <video
    className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
    src="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/workflows-peek.mp4"
    poster="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/workflows-peek.jpg"

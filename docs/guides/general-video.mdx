...
<Frame caption="From a film about editing on the timeline. The custom path composes whatever the focused workflows do not cover.">
  <video
    ...
    src="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/wfv2-general.mp4"
    poster="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/wfv2-general.jpg"

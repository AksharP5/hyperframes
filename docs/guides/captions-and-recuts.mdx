...
<Frame caption="The Highlight caption style, running over footage that is left untouched underneath.">
  <video
    className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
    src="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/wf-captions.mp4"
    poster="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/wf-captions.jpg"

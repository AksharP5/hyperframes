...
<div className="not-prose my-6 space-y-8">
  <ReplicaCompare
    title="THE OBLIST"
    meta="38.58s · 60fps"
    refSrc="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/reverse-oblist-reference.mp4"
  ...
  <ReplicaCompare
    ...
    refSrc="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/reverse-srinika-reference.mp4"

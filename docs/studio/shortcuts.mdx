...
The selected area decides what a shared shortcut does. Arrow keys nudge a selected
canvas element, and step through frames when nothing nudgeable is selected. `J`

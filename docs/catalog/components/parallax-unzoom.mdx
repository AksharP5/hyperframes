...
Open `compositions/components/parallax-unzoom.html` and paste its contents into your composition. The comment header in that file contains any item-specific instructions.

...
Open `compositions/components/caption-weight-shift.html` and paste its contents into your composition. The comment header in that file contains any item-specific instructions.

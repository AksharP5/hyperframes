...
<Frame caption="A website goes in; HyperFrames plans it, builds it, and renders the film. The finished launch film, made with HyperFrames — press play for sound.">
  <video
    ...
    src="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/hero-web2vid-v2.mp4"
    poster="https://static.heygen.ai/hyperframes-oss/docs/images/showcase/hero-web2vid-v2.jpg"
    autoPlay
    muted
    loop
    playsInline
